...
public class TransactionServiceLogger {
  ...
  @AfterReturning(
      "execution(* com.agilebank.service.transaction.TransactionService.storeTransaction(..))")
  ...
  @AfterReturning(
      "execution(* com.agilebank.service.transaction.TransactionService.getTransaction(..))")
  ...
  @Before(
      "execution(* com.agilebank.service.transaction.TransactionService.getAllTransactions(..))")
  ...
  @Before(
      "execution(* com.agilebank.service.transaction.TransactionService.getAllTransactionsFrom(..))")
  ...
  @Before(
      "execution(* com.agilebank.service.transaction.TransactionService.getAllTransactionsTo(..))")
  ...
  @Before(
      "execution(* com.agilebank.service.transaction.TransactionService.getAllTransactionsBetween(..))")
  ...
  @AfterReturning(
      "execution(* com.agilebank.service.transaction.TransactionService.deleteTransaction(..))")
  ...
  @Before(
      "execution(* com.agilebank.service.transaction.TransactionService.deleteAllTransactions(..))")
