...
public class AgileBankIntegrationTest {
    ...
    @Autowired
    private CurrencyLedgerController currencyLedgerController;
    ...
    public void whenPostingAValidAccount_accountCanThenBeFound(){
        ...
        assertEquals(ResponseEntity.ok(accountModelAssembler.toModel(TEST_ACCOUNT_DTO_ONE)),
    ...
    public void whenPostingTwoValidAccounts_getAllFindsThemBoth(){
        ...
        assertEquals(ResponseEntity.ok(CollectionModel.of(
