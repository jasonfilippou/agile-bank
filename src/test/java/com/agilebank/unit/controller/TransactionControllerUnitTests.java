...
public class TransactionControllerUnitTests {
    ...
    public void whenGettingAllTransactionsFromAcc1_returnOnlyThoseTransactions(){
        ...
        assertEquals(ResponseEntity.ok(TEST_ENTITY_MODEL_COLLECTION_MODEL_FROM_ACCOUNT_ONE), transactionController.getAllTransactions(Map.of(SOURCE_ACCOUNT_ID, ACCOUNT_ONE_ID)));
    }
    ...
    public void whenGettingAllTransactionsToAcc2_returnOnlyThoseTransactions(){
        ...
        assertEquals(ResponseEntity.ok(TEST_ENTITY_MODEL_COLLECTION_MODEL_TO_ACCOUNT_TWO), transactionController.getAllTransactions(Map.of(TARGET_ACCOUNT_ID, ACCOUNT_TWO_ID)));
    }
    ...
    public void whenGettingAllTransactionsFromAcc1ToAcc2_returnOnlyThoseTransactions(){
        ...
        assertEquals(ResponseEntity.ok(TEST_ENTITY_MODEL_COLLECTION_MODEL_FROM_ACCOUNT_ONE_TO_ACCOUNT_TWO), transactionController.getAllTransactions(Map.of(SOURCE_ACCOUNT_ID, ACCOUNT_ONE_ID, TARGET_ACCOUNT_ID, ACCOUNT_TWO_ID)));
    }
}
