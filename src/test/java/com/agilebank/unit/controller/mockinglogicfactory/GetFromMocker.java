...
public class GetFromMocker extends BaseMocker {


    public GetFromMocker(TransactionService transactionService, TransactionModelAssembler transactionModelAssembler) {
