...
public class TransactionSanityCheckerUnitTests {
    ...
    transactionSanityChecker.checkTransaction(TEST_TRANSACTION_DTO_ONE, Optional.empty(),
            Optional.of(TEST_ACCOUNT_DAO_ONE), TEST_EXCHANGE_RATES);
    }

    @Test(expected = NonExistentAccountException.class)
    public void whenTargetAccountIsNonExistent_thenNonExistentAccountExceptionIsThrown(){
        transactionSanityChecker.checkTransaction(TEST_TRANSACTION_DTO_ONE, Optional.of(TEST_ACCOUNT_DAO_THREE),
    ...
    public void whenTransactionIsOverANonPositiveAmountOfCurrency_thenInvalidAmountExceptionIsThrown(){
        ...
        transactionSanityChecker.checkTransaction(TEST_TRANSACTION_DTO_THREE, Optional.of(TEST_ACCOUNT_DAO_ONE),
                Optional.of(TEST_ACCOUNT_DAO_THREE), TEST_EXCHANGE_RATES);
    }
    ...
    public void whenTransactionAmountIsTooMuchForSourceAccount_thenInsufficientBalanceExceptionIsThrown(){
        ...
        transactionSanityChecker.checkTransaction(TEST_TRANSACTION_DTO_TWO, Optional.of(TEST_ACCOUNT_DAO_ONE),
                Optional.of(TEST_ACCOUNT_DAO_TWO), TEST_EXCHANGE_RATES);
    }
    ...
    public void whenTransactionIsOk_thenOk(){
        ...
        try {
            transactionSanityChecker.checkTransaction(TEST_TRANSACTION_DTO_ONE, Optional.of(TEST_ACCOUNT_DAO_ONE),
                    Optional.of(TEST_ACCOUNT_DAO_TWO), TEST_EXCHANGE_RATES);
